        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                <h2 className="flex-column items-center justify-between text-3xl font-extrabold tracking-tight sm:text-4xl">
                    <FontAwesomeIcon icon={faDrawPolygon} className="mx-auto block text-indigo-600" />
                    <span className="mx-auto text-center block text-gray-50">Sign in to your account</span>
                </h2>
                <form className="mt-8 space-y-6" action="#" method="POST" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-center space-x-2">
                        <div className="text-sm">
                        <p className="text-sm ml-2 block text-sm text-gray-100">You aren´t sharing yet?</p>
                        </div>
                        <div className="text-sm">
                            <Link to={ROUTES.SIGN_UP} className="font-medium text-indigo-600 hover:text-indigo-500">Sign up</Link>
                        </div>
                    </div>
                </form>
            </div>
